...
```java
public class GenericsInterface implements Content<Integer> {
    private int text;

    public GenericsInterface(int text) {
        this.text = text;
    }
    ...
    public static void main(String[] args) {
        GenericsInterface demo = new GenericsInterface(10);
...
```java
public class GenericsInterface<T> implements Content<T> {
    private T text;

    public GenericsInterface(T text) {
        this.text = text;
    }
    ...
    public static void main(String[] args) {
        GenericsInterface<String> gen = new GenericsInterface<>("ABC");
